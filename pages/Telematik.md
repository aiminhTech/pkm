...
- ## Netzwerk Komponente
	- ### NIC (Network Interface Card)
		- **Layer 1**
			...
			- *Funktion*:
				- Signale auf der physischen Schicht senden.
...
- ## Adressierung
	...
	- ### IPv6
	  collapsed:: true
		...
		- #### Adressentypen
			- ##### Unicast
				- ![Bildschirmfoto 2023-08-06 um 21.31.11.png](../assets/Bildschirmfoto_2023-08-06_um_21.31.11_1691350274208_0.png){:height 146, :width 144}
				- für ein Interface
